...
Para añadir en el fichero hosts las IPs y nombres de equipos, ejecuté un bloc de notas (llamado hosts) como administrador donde escribí lo de la foto y lo guardé en C:\Windows\System32\drivers\etc
