...
He importado y configurado los siguientes equipos:

![fotoyeah](./1.png)

Se van a conectar mediante adaptador puente e IP estática configurada desde el panel de control de cada equipo, cada uno la suya.
...
Para comprobar que funciona crea, desde el equipo con entorno gráfico, un usuario con privilegios de administrador llamado admin_{iniciales}. Si no sabes cómo hacerlo tienes una breve guía aquí
